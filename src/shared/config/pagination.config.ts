...
export const BLOG_LIMIT = parseInt(process.env.BLOG_LIMIT ?? '1');
...
export const FRONT_BLOG_LIMIT = parseInt(process.env.FRONT_BLOG_LIMIT ?? '1');
...
export const USERS_LIMIT = parseInt(process.env.USERS_LIMIT ?? '1');
...
export const PRODUCTS_LIMIT = parseInt(process.env.PRODUCTS_LIMIT ?? '1');
...
export const FRONT_INVENT_PRODUCTS_LIMIT = parseInt(process.env.FRONT_INVENT_PRODUCTS_LIMIT ?? '1');
...
export const INVENTORY_LIMIT = parseInt(process.env.INVENTORY_LIMIT ?? '1');
...
export const ORDER_LIMIT = parseInt(process.env.ORDER_LIMIT ?? '1');
